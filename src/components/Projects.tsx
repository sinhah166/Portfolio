    ...
    <section id="projects" className="py-16 sm:py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 mb-4">Featured Projects</h2>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="relative">
                    <p className={`text-slate-600 mb-1 transition-all duration-300 ${isExpanded ? '' : 'line-clamp-3'}`}>
                      {project.description}
                    </p>
                    <button
