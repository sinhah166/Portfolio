...
// EmailJS credentials
const EMAILJS_SERVICE_ID = 'service_fy2mhyu';
const EMAILJS_TEMPLATE_ID = 'template_hr8d4je';
const EMAILJS_PUBLIC_KEY = 'gLccT1KhZhvAdHUTq';
    ...
    <section id="contact" className="py-16 sm:py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-start">
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-5 sm:p-8 shadow-xl">
      ...
      <footer className="mt-16 sm:mt-24 pt-8 sm:pt-12 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
